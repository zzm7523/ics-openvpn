...
public class AboutFragment extends Fragment implements View.OnClickListener {
    ...
    private void createPlayBuyOptions(ArrayList<String> ownedSkus, ArrayList<String> responseList) {
        try {
            ...
            VpnStatus.logThrowable("Parsing Play Store IAP", ex);
        }
    }
    ...
    private void triggerBuy(String sku) {
        try {
            Bundle buyBundle = mService.getBuyIntent(3, getActivity().getPackageName(),
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        verO2.setText(String.format(Locale.US, "OpenVPN version: %s", NativeUtils.getOpenVPNGitVersion()));
