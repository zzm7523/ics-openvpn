...
public class NetworkSpace {
    ...
    static class IpAddress implements Comparable<IpAddress> {
        ...
        public IpAddress(@NonNull CIDRIP ip, boolean include) {
        ...
        public IpAddress(@NonNull Inet6Address address, int mask, boolean include) {
            networkMask = mask;
            included = include;
        ...
        IpAddress(@NonNull BigInteger baseAddress, int mask, boolean included, boolean isV4) {
    ...
    public void addIP(@NonNull CIDRIP cidrIp, boolean include) {
        mIpAddresses.add(new IpAddress(cidrIp, include));
    }

    public void addIPSplit(@NonNull CIDRIP cidrIp, boolean include) {
    ...
    public void addIPv6(@NonNull Inet6Address address, int mask, boolean included) {
